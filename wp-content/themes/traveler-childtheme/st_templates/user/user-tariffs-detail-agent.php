  ...
  <div class="col-xs-12"> 
    ...
    <div class="box-body">
      ...
      <div class="panel panel-default col-lg-12 col-md-12 col-sm-12 col-xs-12" style="float:left;padding:0px;">
        ...
        list($activeTariffCountryCode, $activeTariffType, $activeTariffMarketCode, $activeTariffYear) = explode('-', $hotelTariff->post_title);      
        ...
        if ( $currentYear == $activeTariffYear ) {
                ...
                $checkMarket = "false";
                if ( (strpos($hotelTariff->post_title, '-' . $role) == true ) || (strpos($hotelTariff->post_title, '-' . $role . ',') == true) || (strpos($hotelTariff->post_title, ',' . $role . ',') == true)) {
									$checkMarket = "true";
								}
                ?>
                ...
                <li class='list-group-item float-left col-lg-12 col-md-12 col-sm-12 col-xs-12'> <i class='fa fa-caret-right'></i> &nbsp;<?php echo $hotelTariff->post_content ?>
                 <?php echo $hotelTariff->post_title . ' >>444 '  . ((strpos($hotelTariff->post_title, '-' . $role . '-'))? "true" : "false") . ' == ' . $role ; ?> 
