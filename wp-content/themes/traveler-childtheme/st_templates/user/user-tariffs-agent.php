...
?>
	...
	?>
          <div class="btn-sm col-lg-3 col-md-3 col-sm-3 col-xs-12">
            <button class="btn btn-block btn-default" onclick='funcTariffDetail("<?php echo strtr(base64_encode($arrTariffCountry[$iTariffCountryCount]["country_code"] . '~'. $arrTariffCountry[$iTariffCountryCount]["country_name"] . '~' . $currentYear . '~' . $increaseOneYear), '+/=', '._-') ?>")'>
...
<script type = "text/javascript">  
	function funcTariffDetail(data){
		window.location.href = "../tariffs-detail-agent/?data=" + data;
	};
 </script> 
