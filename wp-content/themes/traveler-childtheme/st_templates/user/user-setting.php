    ...
    <div class="col-md-5">
        ...
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="form-group form-group-icon-left">
                <label for="st_name"><?php echo __('Username', ST_TEXTDOMAIN); ?></label><i class="fa fa-user input-icon"></i>
                <input readonly class="form-control" value="<?php echo esc_attr($data->user_login) ?>" type="text" style="background: #dfdfdf;"/>
            </div>

            <div class="form-group form-group-icon-left">
                <label for="st_name"><?php echo __('Display name', ST_TEXTDOMAIN); ?></label><i class="fa fa-user input-icon"></i>
