        ...
        <div class="featured-image">
            <?php
                ...
                if ( $is_featured == 'on' ) {
                    ...
                    <div class="featured" style="background-color:#49a0df !important;">
        ...
        <div class="section-footer">
            <div class="reviews">
                <span class="rate"><?php echo esc_attr( $review_rate ); ?>
                    /5 <?php 
                     //echo TravelHelper::get_rate_review_text( $review_rate ); 
                     //echo (($review_rate == 0) ? 'No Review' : TravelHelper::get_rate_review_text( $review_rate ));
                    ?>
                </span>
                <span class="summary">
