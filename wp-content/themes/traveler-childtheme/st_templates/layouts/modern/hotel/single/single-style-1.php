                                    ...
                                    <div class="review-box has-matchHeight">
                                        ...
                                        <div class="review-box-score">
                                            ...
                                            <div class="review-score-text">
                                                <?php 
                                                // echo TravelHelper::get_rate_review_text( $avg ); 
                                                 echo (($avg == 0) ? 'No Review' : TravelHelper::get_rate_review_text( $avg ));
                                                ?>
                                            </div>
                                        ...
                                        <div class="item">
                                            ...
                                            <div class="reviews">
                                                <span class="rate"><?php echo esc_attr( $review_rate ); ?>/5
                                                    <?php echo TravelHelper::get_rate_review_text( $review_rate ); ?></span><span
