...
if (($lever == "wwa") || 
							...
							($lever == "rub")          
								   ...
								   $default_page = "../tariffs-agent/"; 
								   header('Location: ' . '../tariffs-agent/', true, $permanent ? 301 : 302); 
								  }
            ...
            <div class="col-md-3 user-left-menu ">
                <div class="page-sidebar navbar-collapse st-page-sidebar-new">
                    <ul class="page-sidebar-menu st_menu_new">
                        ...
                        ?>
                        <li class="heading user-profile-sidebar">
                            <?php
                                $check_upgrade = false;
                            ...
                            ?>
                            <div class="user-profile-avatar <?php echo $check_upgrade ? 'has-button' : ''; ?>">
                        ...
                        <?php } else { ?>
                            ...
                            <!-- Traiff Operation -->
                            <?php if ($lever == "partner") { ?>
                                    <li class="item item-withdrawal <?php if (in_array($sc, array('tariffs-partner','tariffs-detail-partner', 'tariffs-upload', 'tariffs-edit'))) echo "active" ?>"> <a href="<?php echo TravelHelper::get_user_dashboared_link($user_link, 'tariffs-partner'); ?>"> <i class="fa fa-folder"></i>
                                                <?php echo "Tariffs"; ?>
                                    <span class="arrow"></span> </a>
                                    <ul class="sub-menu item">
                                        <li <?php if ($sc == 'tariffs-upload') echo 'class="active"' ?>> <a href="<?php echo TravelHelper::get_user_dashboared_link($user_link, 'tariffs-upload'); ?>"> <i class="fa fa-upload">&nbsp;</i>
                                                <?php echo "Upload Tariffs"; ?>
                                        </a> </li>
                                        <li class="<?php if (in_array($sc, array('tariffs-partner', 'tariffs-detail-partner', 'tariffs-edit'))) echo "active" ?>"> <a href="<?php echo TravelHelper::get_user_dashboared_link($user_link, 'tariffs-partner'); ?>"><i class="fa fa-file-o">&nbsp;</i>
                                            <?php echo "Tariff List"; ?>
                                        </a> </li>
                                    </ul>
                                </li>
                            <?php } ?>
...
<!--                            </li>-->
                        ...
                        <?php } ?>
                        <li class="logout">
                            <a href="<?php echo wp_logout_url() ?>"><i class="fa fa-sign-out"></i> <?php echo __( 'Log Out', ST_TEXTDOMAIN ) ?></a>
                        </li>
                        <li class="backtohome">
                            <a href="<?php echo site_url() ?>"><?php echo __('Back to Homepage', ST_TEXTDOMAIN); ?></a>
                        </li>
                        <?php
            ...
            <div class="user-content <?php echo $show_menu?'col-md-9':'col-md-12' ?>">
                ...
                if (!empty($_REQUEST['id_user'])) {
                    ...
                    if (STUser_f::check_lever_partner($lever)) {
                        ...
                        $arr_page_menu = ["overview", "setting", "setting-info", "tariffs-partner","wishlist", "booking-history", "certificate", "write_review", "inbox"];
