            ...
            if (!empty($_REQUEST['sc'])) {
                ...
                switch ($type) {
                    case "setting":
                        ...
                        break;
                    /* tariff */
                    case "tariffs-partner":
                        esc_html_e('Tariffs','traveler');
                        break;
                    case "tariffs-detail-partner":
                        esc_html_e('Tariffs','traveler');
                        break;
                    case "tariffs-upload":
                        esc_html_e('Upload Tariffs','traveler');
                        break;
                    case "tariffs-edit":
                        esc_html_e('Edit Tariffs','traveler');
                        break;
                    case "tariffs-market":
                        esc_html_e('Tariff List','traveler');
                        break;
                    case "photos":
        ...
        */
        ...
        static function st_get_breadcrumb_partner()
        {
            ...
            switch ($sc) {
                ...
                /* tariff */
                case "tariffs":
                    $html .= '<li>&nbsp;' . __(" Tariffs ", ST_TEXTDOMAIN) . '</li>';
                    break;
                case "tariffs-partner":
                    $html .= '<li>&nbsp;' . __(" Tariffs ", ST_TEXTDOMAIN) . '</li>';
                    break;							
                 case "tariffs-detail-partner":
                    ...
                    break;				
                case "tariffs-upload":
                    $html .= '<li>&nbsp;' . __(" Upload Tariffs ", ST_TEXTDOMAIN) . '</li>';
                    break;					
                case "tariffs-edit":
                    $html .= '<li>&nbsp;' . __(" Edit Tariffs ", ST_TEXTDOMAIN) . '</li>';
                    break;					
                case "tariffs-market":
                    $html .= '<li>&nbsp;' . __(" Tariffs List ", ST_TEXTDOMAIN) . '</li>';
                    break;
                case "overview":
