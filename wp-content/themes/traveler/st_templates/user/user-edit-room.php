                ...
                <div class="add_service_step" id="step_price_setting">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb30">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="discount_by_number_of_day"><?php _e("Discount by No.Days",ST_TEXTDOMAIN) ?>: </label>
                                    <div class="content_extra_price">
                                        <div class="list-properties">
                                            <?php if(!empty($post_id)){ ?>
                                                <?php
                                                $discount_by_day = get_post_meta($post_id, 'discount_by_day', true);
                                                if(is_array($discount_by_day) && count($discount_by_day)):
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xs-12">
                                                                        <div class="form-group form-group-icon-left">
                                                                            ...
                                                                            <i class="fa fa-file-text input-icon input-icon-hightlight"></i>
                                                                            <input value="<?php echo esc_html($val['number_day']); ?>" id="discount_by_day_number_day" name="discount_by_day[number_day][]" type="text" placeholder="<?php _e("No. days",ST_TEXTDOMAIN) ?>" class="form-control">
                                                                            <small><?php echo __('Enter No. days will be discounted', ST_TEXTDOMAIN); ?></small>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-xs-12">
                                                                        <div class="form-group form-group-icon-left">
                                                                            ...
                                                                            <i class="fa fa-file-text input-icon input-icon-hightlight"></i>
                                                                            <input value="<?php echo esc_html($val['discount']); ?>" id="discount_by_day_discount"  name="discount_by_day[discount][]" type="text" placeholder="<?php _e("Discount",ST_TEXTDOMAIN) ?>" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xs-12">
                                                                        <div class="form-group form-group-icon-left">
                                                                            <label for="discount_by_day_number_day"><?php _e("No. days",ST_TEXTDOMAIN) ?></label>
                                                                            <i class="fa fa-file-text input-icon input-icon-hightlight"></i>
                                                                            <input value="<?php echo esc_html($discount_by_day['number_day'][$key]); ?>" id="discount_by_day_number_day" data-date-format="yyyy-mm-dd" name="discount_by_day[number_day][]" type="text" placeholder="<?php _e("No. days",ST_TEXTDOMAIN) ?>" class="form-control">
                                                                            <small><?php echo __('Enter No. days will be discounted', ST_TEXTDOMAIN); ?></small>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-xs-12">
                                                                        <div class="form-group form-group-icon-left">
                                                                            <label for="discount_by_day_discount"><?php _e("Discount",ST_TEXTDOMAIN) ?></label>
                                                                            <i class="fa fa-file-text input-icon input-icon-hightlight"></i>
                                                                            <input value="<?php echo esc_html($discount_by_day['discount'][$key]); ?>" id="discount_by_day" data-date-format="yyyy-mm-dd" name="discount_by_day[discount][]" type="text" placeholder="<?php _e("Discount",ST_TEXTDOMAIN) ?>" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <a href="javascript:void(0);" class="btn btn-primary add-list-item mt10" data-get-html="#list-item-discount-by-nodays">+</a>
                                    </div>
                                </div>

                                <!--Discount type for discount by no.days-->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="discount_type_no_day"><?php echo __('Discount type', ST_TEXTDOMAIN); ?></label>
                                        ...
                                        <small><?php echo __('This only use for discount by number of days. Caculation by: % or fixed', ST_TEXTDOMAIN); ?></small>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 div_btn_add_custom hidden">
                            <div class="form-group form-group-icon-left">
...
<!--Template for discount by no.days-->
<div id="list-item-discount-by-nodays" style="display: none">
    <div class="property-item tab-item">
        <a href="javascript: void(0);" class="delete-tab-item btn btn-danger">x</a>
        <div class="tab-title">&nbsp;</div>
        <div class="tab-content">
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="form-group form-group-icon-left">
                        <label for="discount_by_day_number_day"><?php _e("No. days",ST_TEXTDOMAIN) ?></label>
                        <i class="fa fa-file-text input-icon input-icon-hightlight"></i>
                        <input value="" id="discount_by_day_number_day" data-date-format="yyyy-mm-dd" name="discount_by_day[number_day][]" type="text" placeholder="<?php _e("No. days",ST_TEXTDOMAIN) ?>" class="form-control">
                        <small><?php echo __('Enter No. days will be discounted', ST_TEXTDOMAIN); ?></small>
                    </div>
                </div>
                <div class="col-xs-12">
                    <div class="form-group form-group-icon-left">
                        <label for="discount_by_day_discount"><?php _e("Discount",ST_TEXTDOMAIN) ?></label>
                        <i class="fa fa-file-text input-icon input-icon-hightlight"></i>
                        <input value="" id="discount_by_day_discount" data-date-format="yyyy-mm-dd" name="discount_by_day[discount][]" type="text" placeholder="<?php _e("Discount",ST_TEXTDOMAIN) ?>" class="form-control">
                    </div>
                </div>
            </div>
        </div>
...
<!--End Template for discount by no.days-->