                            ...
                            <div class="col-md-4">
                                <div class="form-group form-group-icon-left">
                                    ...
                                    <input id="base_price" name="base_price" type="text"
                                           ...
                                           value="<?php echo STInput::request('base_price', (float)get_post_meta($post_id, 'base_price', true)) ?>">
                            ...
                            <div class="col-md-4">
                                <div class="form-group form-group-icon-left">
                                    ...
                                    <input data-rules="required" id="adult_price" name="adult_price" type="text"
                                           ...
                                           class="number form-control"
                                           value="<?php echo STInput::request('adult_price', (float)get_post_meta($post_id, 'adult_price', true)) ?>">
                            ...
                            <div class="col-md-4">
                                <div class="form-group form-group-icon-left">
                                    ...
                                    <input data-rules="required" id="child_price" name="child_price" type="text"
                                           ...
                                           class="number form-control"
                                           value="<?php echo STInput::request('child_price',(float)get_post_meta($post_id, 'child_price', true)) ?>">
                            ...
                            <div class="col-md-4">
                                <div class="form-group form-group-icon-left">
                                    ...
                                    <input data-rules="required" id="infant_price" name="infant_price" type="text"
                                           ...
                                           value="<?php echo STInput::request('infant_price', (float)get_post_meta($post_id, 'infant_price', true)) ?>">
                    ...
                    <div class="row">
                        ...
                        <div class='col-md-6'>
                            <div class="form-group">
                                ...
                                <input data-rules="required" id="min_people" name="min_people" type="text" min="1"
                                       ...
                                       value="<?php echo STInput::request('min_people', (int)get_post_meta($post_id, 'min_people', true)) ?>">
                        ...
                        <div class='col-md-6'>
                            <div class="form-group">
                                ...
                                <input id="max_people" name="max_people" type="text" min="0"
                                       ...
                                       value="<?php echo STInput::request('max_people', (int)get_post_meta($post_id, 'max_people', true)) ?>">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="tours_include"><?php _e("Tour Include", ST_TEXTDOMAIN) ?>:</label>
                                        <textarea id="tours_include" name="tours_include"  class="form-control"><?php echo STInput::request('tours_include', get_post_meta($post_id, 'tours_include', true)) ?></textarea>
                                        <div class="st_msg"><?php echo STUser_f::get_msg_html($validator->error('tours_include'), 'danger') ?></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="tours_exclude"><?php _e("Tour Exclude", ST_TEXTDOMAIN) ?>:</label>
                                        <textarea id="tours_exclude" name="tours_exclude"  class="form-control"><?php echo STInput::request('tours_exclude', get_post_meta($post_id, 'tours_exclude', true)) ?></textarea>
                                        <div class="st_msg"><?php echo STUser_f::get_msg_html($validator->error('tours_exclude'), 'danger') ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-group-icon-left">
                                        <label for="tour_program"><?php _e("Tour FAQ", ST_TEXTDOMAIN) ?>:</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <?php if (!empty($post_id)) { ?>
                                    <?php $tours_faq_program = get_post_meta($post_id, 'tours_faq', true); ?>
                                    <div class="" id="data_tours_faq">
                                        <?php
                                        if (!empty($tours_faq_program)) {
                                            foreach ($tours_faq_program as $k => $v) {
                                                ?>
                                                <div class="item">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="program_title"><?php echo __('Title', ST_TEXTDOMAIN) ?></label>
                                                            <input id="title" name="tours_faq_title[]" type="text"
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="tours_faq_desc[]"
                                                                      class="form-control h_35"><?php echo balanceTags($v['desc']) ?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-1">
                                                        <div class="form-group form-group-icon-left">
                                                            <div class="btn btn-danger btn_del_tours_faq" style="margin-top: 27px">
                                                                X
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <?php } else { ?>
                                    <?php
                                    $tours_faq_title = STInput::request('tours_faq_title');
                                    $tours_faq_desc = STInput::request('tours_faq_desc');
                                    ?>
                                    <div class="" id="data_tours_faq">
                                        <?php
                                        if (!empty($tours_faq_title)) {
                                            foreach ($tours_faq_title as $k => $v) {
                                                if (!empty($v) and !empty($tours_faq_desc[$k])) {
                                                    ?>
                                                    <div class="item">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-7">
                                                            <div class="form-group">
                                                                <label for="program_desc"><?php st_the_language('user_create_tour_program_desc') ?></label>
                                                                <textarea name="tours_faq_desc[]"
                                                                          class="form-control h_35"><?php echo stripslashes($tours_faq_desc[$k]) ?></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-1">
                                                            <div class="form-group form-group-icon-left">
                                                                <div class="btn btn-danger btn_del_tours_faq"
                                ...
                                <div class="col-md-8">
                                    <div class="form-group form-group-icon-left">
                                        <button id="btn_add_tours_faq" type="button"
                                                class="btn btn-info"><?php echo __('Add New', ST_TEXTDOMAIN) ?></button>
                                        <br>
                                    </div>
                                </div>
                            </div>
...
<div id="html_tours_faq" style="display: none">
    <div class="item">
        <div class="col-md-4">
            <div class="form-group">
                <label for="program_title"><?php echo __('Title', ST_TEXTDOMAIN) ?></label>
        ...
        <div class="col-md-7">
            <div class="form-group">
                <label for="program_desc"><?php st_the_language('user_create_tour_program_desc') ?></label>
                <textarea name="tours_faq_desc[]"
                          class="form-control h_35"></textarea>
            </div>
        </div>
        <div class="col-md-1">
            <div class="form-group form-group-icon-left">
