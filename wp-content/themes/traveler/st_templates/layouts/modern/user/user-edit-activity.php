                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="activity_include"><?php _e("Activity Include", ST_TEXTDOMAIN) ?>:</label>
                                        <textarea id="activity_include" name="activity_include"  class="form-control"><?php echo STInput::request('activity_include', get_post_meta($post_id, 'activity_include', true)) ?></textarea>
                                        <div class="st_msg"><?php echo STUser_f::get_msg_html($validator->error('activity_include'), 'danger') ?></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="activity_exclude"><?php _e("Activity Exclude", ST_TEXTDOMAIN) ?>:</label>
                                        <textarea id="activity_exclude" name="activity_exclude"  class="form-control"><?php echo STInput::request('activity_exclude', get_post_meta($post_id, 'activity_exclude', true)) ?></textarea>
                                        <div class="st_msg"><?php echo STUser_f::get_msg_html($validator->error('activity_exclude'), 'danger') ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="activity_highlight"><?php _e("Activity Highlight", ST_TEXTDOMAIN) ?>:</label>
                                <textarea id="activity_highlight" name="activity_highlight"  class="form-control"><?php echo STInput::request('activity_highlight', get_post_meta($post_id, 'activity_highlight', true)) ?></textarea>
                                <div class="st_msg"><?php echo STUser_f::get_msg_html($validator->error('activity_highlight'), 'danger') ?></div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="row">
                            ...
                            <div class="row">
                                <?php if (!empty($post_id)) { ?>
                                    <?php $activity_faq_program = get_post_meta($post_id, 'activity_faq', true); ?>
                                    <div class="" id="data_activity_faq">
                                        <?php
                                        if (!empty($activity_faq_program)) {
                                            foreach ($activity_faq_program as $k => $v) {
                                                ?>
                                                <div class="item">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="program_title"><?php echo __('Title', ST_TEXTDOMAIN) ?></label>
                                                            <input id="title" name="activity_faq_title[]" type="text"
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="activity_faq_desc[]"
                                                                      class="form-control h_35"><?php echo balanceTags($v['desc']) ?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-1">
                                                        <div class="form-group form-group-icon-left">
                                                            <div class="btn btn-danger btn_del_activity_faq" style="margin-top: 27px">
                                                                X
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <?php } else { ?>
                                    <?php
                                    $activity_faq_title = STInput::request('activity_faq_title');
                                    $activity_faq_desc = STInput::request('activity_faq_desc');
                                    ?>
                                    <div class="" id="data_activity_faq">
                                        <?php
                                        if (!empty($activity_faq_title)) {
                                            foreach ($activity_faq_title as $k => $v) {
                                                if (!empty($v) and !empty($activity_faq_desc[$k])) {
                                                    ?>
                                                    <div class="item">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-7">
                                                            <div class="form-group">
                                                                <label for="program_desc"><?php st_the_language('user_create_tour_program_desc') ?></label>
                                                                <textarea name="activity_faq_desc[]"
                                                                          class="form-control h_35"><?php echo stripslashes($activity_faq_desc[$k]) ?></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-1">
                                                            <div class="form-group form-group-icon-left">
                                                                <div class="btn btn-danger btn_del_activity_faq"
                                ...
                                <div class="col-md-8">
                                    <div class="form-group form-group-icon-left">
                                        <button id="btn_add_activity_faq" type="button"
...
<div id="html_activity_faq" style="display: none">
    <div class="item">
        <div class="col-md-4">
            <div class="form-group">
                <label for="program_title"><?php echo __('Title', ST_TEXTDOMAIN) ?></label>
