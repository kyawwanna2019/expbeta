        ...
        <div class="col-sm-3 section-footer">
            <div class="service-review hidden-xs">
                ...
                <div class="count-review">
                    <span class="text-rating"><?php echo TravelHelper::get_rate_review_text($avg); ?></span>
            ...
            <div class="service-review hidden-lg hidden-md hidden-sm">
                ...
                $avg = STReview::get_avg_rate();
                ?>
                <span class="rating"><?php echo $avg; ?>/5 <?php echo TravelHelper::get_rate_review_text($avg); ?></span>
